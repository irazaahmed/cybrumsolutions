...
const SKILLS: SeedSkill[] = [
  ...
  // ----------------------------------------------------------- Religious Studies
  {
    title: "Khutbah & Da'wah Content Assistant",
    slug: "khutbah-dawah-content-assistant",
    category: "Religious Studies",
    tags: ["islamic-scholarship", "khutbah", "dawah", "sermon-writing", "multilingual", "imam"],
    description:
    ...
    usageNotes: md([
      "## When to use",
      "Preparing a Friday khutbah, a lecture (bayan) outline, or short da'wah posts for",
      "social media, when you know the topic and audience but want structure and time",
      "saved on drafting.",
      "",
      "## Inputs",
      "Topic (required), audience, language, format (khutbah, lecture, or social post),",
      "length, and the occasion if any (Ramadan, Eid, Jumu'ah, a community issue).",
      "",
      "## Why placeholders, not quotes",
      "The assistant never writes out a Quran ayah, its Arabic text, or a Hadith's",
      "wording or numbering, from memory. Every reference comes back as a marked",
      "placeholder like [VERIFY: Surah Al-Baqarah, theme \"patience\" - confirm exact ayah",
      "and wording from a Mushaf]. AI models can misquote scripture, so every placeholder",
      "must be checked against a Mushaf or an authenticated Hadith source before you",
      "deliver it.",
      "",
      "## Tuning",
