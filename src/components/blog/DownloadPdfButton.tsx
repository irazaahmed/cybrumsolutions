 ...
 *  and logo are locked to what the user sees. Without this, print emulation
 *  flips `prefers-color-scheme` to light, and the "system" theme listener would
...
type Props = {
  ...
  label: string;
  /** Urdu gets the Nastaliq face and a larger size. */
  isUrdu?: boolean;
};
 ...
 */
export function DownloadPdfButton({ label, isUrdu }: Props) {
