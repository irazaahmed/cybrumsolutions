...
function RetrievalModesDiagram() {
  const modes = [
    { icon: Brain, t: "Pretrained", d: "Sirf training data se, fastest, stable facts/definitions ke liye achha, current events pe weak" },
...
function ContextStackDiagram() {
  ...
  return (
    <figure className="my-7">
      ...
      <figcaption className="mt-3 text-center text-xs text-muted">
        6 layers, ek dusre ke upar. Model sirf yehi dekh sakta hai, roughly
        750,000 words tak (4-5 Harry Potter books)
      </figcaption>
    </figure>
  );
}
...
function CostLadderDiagram() {
  ...
  return (
    <figure className="my-7">
      ...
      <figcaption className="mt-3 text-center text-xs text-muted">
        Text pe 50 baar iterate kar sakte ho ek din mein, video pe nahi,
...
function MultiModelLoopDiagram() {
  return (
    <figure className="my-7">
      ...
      />
      <figcaption className="mt-1 text-center text-xs text-muted">
        Alag family ke models ke alag blind spots hain, unki disagreement hi
        wo signal hai jo ek model akela nahi de sakta
      </figcaption>
    </figure>
  );
}
      ...
      <main className="mx-auto max-w-3xl px-5 pb-20 sm:px-8">
        <section id="intro" className="scroll-mt-24 pt-4">
          <Reveal>
            ...
            <CoreIdea>
              Zyada tar log AI ko Google search ki tarah use karte hain: ek
              chhota sawal type karte hain, answer skim karte hain, aage barh
              jate hain. Power users different karte hain: files, context,
              constraints ke sath brief karte hain, jaise ek smart lekin naye
              colleague ko. Farq cleverness ka nahi, ek handful ki habits ka
              hai jo koi bhi ek dopeher mein seekh sakta hai. Ye chapter wahi
              afternoon hai: 13 concepts, 4 parts mein.
            </CoreIdea>
          </Reveal>

          <Reveal>
            <SubHeading>Ek Fact Jo Sab Kuch Underneath Hai</SubHeading>
            <P>
              Model <Strong>stateless</Strong> hai, iska apna koi memory nahi
              turns ke beech, aur har baar sirf usi se answer deta hai jo is
              waqt uske context window mein hai. Isi liye ye course ek insight
              pe based hai: is page ki almost har &ldquo;advanced
              technique&rdquo; do moves mein se ek hai, <Strong>sahi context
              andar dalna</Strong>, ya <Strong>ghalat context bahar
              rakhna</Strong>. Model sirf wahi dekhta hai jo iske context
              window mein hai. Aapka kaam hai control karna ke ismein kya
              jata hai.
            </P>
            <Callout label="Note">
              Examples ChatGPT, Claude, aur Gemini ka reference lete hain
              kyunke zyada tar readers ke paas inmein se koi ek hai. Skills
              kisi bhi modern chat AI par transfer hoti hain.
            </Callout>
          </Reveal>

          <Reveal>
            <SubHeading>Pichle 2 Saal Mein Kya Change Hua</SubHeading>
            <P>
              Agar aapne 2022-23 mein ChatGPT try kiya tha aur usay ek clever
              toy samjha tha, to wo tool aur ye tool alag hain:
            </P>
            <CheckList
              items={[
            ...
            />
            <PullQuote>
              Agar aapka mental model in tools ka 18 mahine bhi purana hai, to
              aap inhe shayad 20% capability pe use kar rahe ho jo ye aaj de
              sakte hain.
            </PullQuote>
          </Reveal>
        </section>
        ...
        <section id="part1" className="scroll-mt-24 border-t border-border pt-12 mt-12">
          <Reveal>
            ...
            <Callout label="AI Slop">
              &ldquo;Slop&rdquo; wo term hai jo AI output ke liye use hota hai
              jo surface pe fluent lekin andar se empty ho, grammatically
              clean, halka Wikipedia jaisa, phrases se bhara jaise &ldquo;in
              today&apos;s fast-paced world&rdquo;, aur ek ghante baad koi
              reader ko yaad nahi rehta. Yehi default hota hai jab aap koi
              context ya constraints nahi dete.
            </Callout>
            <PullQuote>
              AI ek bohot smart fresh college grad jaisa hai. Highly
              motivated. Aapke baare mein abhi zyada nahi jaanta. Usay waise
              hi brief karo. Kya ek naya colleague ye kaam achi tarah karne
              ke liye kaafi information rakhta? Agar nahi, to zyada do.
            </PullQuote>
          </Reveal>
          ...
          <Reveal>
            ...
            <P>
              ...
              senses, ya time nahi tha duniya mein ghoomne ka. Ye massive
              internet text parh ke seekha: Reddit, Quora, Wikipedia, books,
              news, research papers, blogs, forums.
            </P>
            <P>
              Training data mein frequency roughly answer ki reliability ke
              barabar hai:
            </P>
            <CheckList
              items={[
            ...
            <Callout label="Real Example" tone="warn">
              ...
              game ke rules poochhe. AI ne confidently 3 paragraphs de diye.
              Grandmother ne bataya rules almost poore galat thay, AI ne
              doosri regions ki similar games ki descriptions blend kar di
              thi kyunke ye specific game internet pe barely thi. AI ne jhoot
              nahi bola, sparse data se generalize kar diya. Reader ki
              mistake poochhna nahi, confidence ko accuracy samajh lena thi.
            </Callout>
          </Reveal>
          ...
          <Reveal>
            ...
            <P>
              Jab aap koi sawal poochte ho, modern AI chupke se decide karta
              hai kaise answer dena hai: sirf pretrained knowledge se, ya web
              search fire kar ke chand pages parh kar, ya deep research chala
              kar (kai minute, dozens sources, structured report).
            </P>
            ...
            <Callout label="Web Search Kaise Kaam Karti Hai (Aur Kabhi Kyun Galat Padh Leti Hai)" tone="warn">
              ...
              scan karti hai, relevant pages nikalti hai, aur har ek ko ek
              short passage mein reduce karti hai, aksar ek alag, chhota
              model se. Aapse baat karne wala model asal page nahi, uska
              condensed version parhta hai, isi liye kabhi kabhi misrepresent
              kar deta hai, information ek translation layer se guzar ke
              aati hai.
            </Callout>
            <P>
              <Strong>Fix:</Strong> AI ko batao kaunse sources use karne hain
              (&ldquo;WHO, FDA, peer-reviewed studies use karo, forums
              nahi&rdquo;), aur quote maango (&ldquo;har claim ke liye,
              exact sentence quote karo jo usay support karta hai&rdquo;).
            </P>
            <RecapTable
            ...
            />
            <PullQuote>
              Agar sawal &ldquo;X kahan hai&rdquo; hai, Google use karo. Agar
              sawal &ldquo;ye sab dekh kar mujhe kya sochna chahiye&rdquo;
              hai, AI use karo.
            </PullQuote>
          </Reveal>
        </section>
        ...
        <section id="part2" className="scroll-mt-24 border-t border-border pt-12 mt-12">
          <Reveal>
            ...
            <P>
              Insaan active working memory mein sirf 4-7 cheezein hold kar
              sakta hai. Modern AI models ek waqt mein hundreds of thousands
              words hold kar sakti hain, kabhi million tak, roughly 750,000
              words matlab 4-5 Harry Potter books ya kai din ki continuous
              speech. Model ye sab parh sakta hai answer dene se pehle,{" "}
              <Strong>lekin sirf wahi jo aap usay do.</Strong>
            </P>
            <ContextStackDiagram />
            <P>
              Jab aap fresh chat khol kar pehla message type karte ho, model
              zero se start nahi karta. Company ne pehle hi ek system prompt
              desk pe rakhi hoti hai, jaise ek restaurant owner ek naye waiter
              ko customer aane se pehle brief karta hai: &ldquo;friendly
              raho, daily special recommend karo, allergen sawal pe hamesha
              kitchen se check karo, guess mat karo.&rdquo; Waiter har table
              pe wahi instructions follow karta hai, aap wo briefing kabhi
              nahi sunte. Isi liye Claude, ChatGPT, aur Gemini same sawal pe
              alag tone dete hain, personality model mein nahi, company ki
              briefing mein baked hai.
            </P>
            <RecapTable
            ...
            <Callout label="Apni Layer Chhoti Rakho, Aur Prune Karo" tone="warn">
              Ye layer har chat se pehle load hoti hai, isliye tempting hai
              lines add karte rehna. Ek saal baad 20 lines ho jati hain, jinme
              se kuch chupke se ek dusre se contradict karti hain. Anthropic
              ne khud apne products mein 2026 mein zyada tar standing
              instructions delete kar dein, quality mein koi loss nahi hua.
              Har kuch mahine poocho: agar ye line delete karoon, kya AI
              waqai kuch galat karega? Agar nahi, delete karo.
            </Callout>
            ...
            />
            <P>
              5 lines ki sahi context, 5 paragraphs ki cleverness se behtar
              hai.
            </P>
            <SubHeading>6th Layer: AI Ab Aapke Baare Mein Notes Likhta Hai</SubHeading>
            <P>
              Teenon tools ab quietly aapka short profile likhte hain aur har
              naye chat mein load karte hain. Ye contradiction nahi hai: model
              still stateless hai, memory ek note hai jo tool aapke baare
              mein rakhta hai aur desk pe rakh deta hai, ye stack ka 6th
              layer hai, exception nahi.
            </P>
            <RecapTable
            ...
            <Callout label="Ek Warning" tone="warn">
              Agar aap doctor, lawyer, accountant, ya teacher ho, memory note
              ek jagah hai jahan client/student details chupke se jama ho
              sakti hain aur mahinon baad kisi unrelated chat mein resurface
              ho sakti hain. Identifiable details memory se bahar rakho.
            </Callout>
          </Reveal>
          ...
          <Reveal>
            ...
            <P>
              Modern context windows bare hain, infinite nahi, aur recall
              inke andar degrade hota hai. Sab se bari mistake: ek hi lambi
              conversation kai unrelated topics ke across chalate rehna.
            </P>
            <CheckList
              items={[
            ...
            />
            <P>
              Ye jab hota hai to tool chupke se purani turns ko compact kar
              deta hai, summary mein badal deta hai jagah banane ke liye.
              Narrative bach jata hai, specifics nahi. <Strong>Rule of
              thumb: jab topic change ho, naya conversation shuru karo.</Strong>
            </P>
          </Reveal>
          ...
          <Reveal>
            ...
            <P>
              Jab aap khud ko wahi files ya wahi audience description do ya
              zyada chats mein paste karte huye paayein, ye signal hai:
              context ko ek <Strong>project</Strong> mein daalo, prompt mein
              nahi.
            </P>
            <RecapTable
            ...
            />
            <P>
              Claude free plan 5 projects deta hai (unlimited files har ek
              mein), ChatGPT free plan 5 files per project deta hai, Google
              Notebooks/NotebookLM free hai dono. Apna project structure
              usi cap ke around plan karo jo pehle bite karega.
            </P>
          </Reveal>
          ...
          <Reveal>
            ...
            <P>
              2023 tak advice thi &ldquo;think step by step&rdquo; likhna.
              Ab wo mostly obsolete hai. Modern models mein built-in
              reasoning modes hain jo aap directly invoke kar sakte ho: plain
              language mein &ldquo;think hard&rdquo; bol kar, interface ke
              thinking toggle se, ya kuch products khud decide kar lete hain.
            </P>
            <Callout label="Number Jo Yaad Rakhne Layak Hai">
              2025 METR study ne track kiya ke leading model kitna lamba task
              reliably complete kar sakta hai. Mid-2024 mein taqreeban 7
              minute (human ke liye), early-2025 mein roughly 1 hour, aur ye
              length roughly har 7 mahine mein double ho rahi hai.
            </Callout>
...
3. Under what conditions your recommendation flips.`}</PromptBox>
            <P>
              Ye prompt 3 cheezein karta hai: relevant context load karta hai,
              explicitly thinking invoke karta hai, aur structured output
              mangta hai, prose ki deewar nahi.
            </P>
            <Callout label="Kab Thinking Mode Use Nahi Karni" tone="warn">
              Quick lookups, ek paragraph ki summaries, casual brainstorm.
              Thinking mode slower hai aur zyada usage budget leti hai. Save
              karo un sawalon ke liye jinhe aap ek thoughtful colleague ko de
              kar 2 din wait karte.
            </Callout>
          </Reveal>
          ...
          <Reveal>
            ...
            <P>
              AI models human feedback pe train hoti hain, khaas kar kaunse
              responses ko thumbs up mila. Millions users ke across, agree
              karna disagree karne se zyada thumbs up leta hai. Result:
              models aapko wo batane ki taraf biased hain jo aap sunna chahte
              ho.
            </P>
            <Callout label="Real Data" tone="warn">
              November 2025 ki Washington Post analysis (47,000 ChatGPT
              conversations) ne paya ke model &ldquo;yes/correct&rdquo; se
              start karta hai &ldquo;no/wrong&rdquo; se roughly 10 guna zyada
              baar.
            </Callout>
            <SycophancyDiagram />
            <RecapTable
            ...
            <Callout label="Objective-Rubric Pattern">
              Vague evaluation (&ldquo;story ko 100 mein se score karo&rdquo;)
              ki jagah, specific criteria do, har ek ko alag fixed scale pe
              score karwao (1-10 clarity, 1-10 engagement, waghera, ek
              sentence justification ke sath). Number vague praise se zyada
              honest hota hai, kyunke commit karna pichli baat se zyada
              mushkil hai.
            </Callout>
...
to get to 9.5. There is always a next level.`}</PromptBox>
          ...
          <Reveal>
            ...
            <P>
              Ye poore page ka sab se high-leverage habit hai. Baaki sab
              skip kar dein, ye mat karein. AI training mein zyada tar
              internet <Strong>common</Strong> ideas thi, creative nahi.
              Isi liye average creative question par AI ka answer bhi average
              hota hai.
            </P>
...
sum in. Give me 5 new options.`}</PromptBox>
            <Callout label="2 Tareeqe Iterate Karne Ke">
              ...
              result ke liye stronger, output parh kar batao kaunsa hissa
              request se fail hua (audience ignore hui, length constraint
              toota, tone drift hui), sirf wahi hissa change karo. Score
              batata hai kitna door ho, diagnosis batata hai model ko exactly
              kya move karna hai.
            </Callout>
        ...
        <section id="part3" className="scroll-mt-24 border-t border-border pt-12 mt-12">
          <Reveal>
            ...
            <P>
              Modern AI images aur audio dono directions mein handle karta
              hai: aapki uploaded images parh sakta hai, recordings sun sakta
              hai, text se naye images bana sakta hai, aur spoken audio
            ...
            <Callout label="Real Test">
              ...
              &ldquo;convolutional&rdquo; word ko block kar raha tha. AI ne
              baaki diagram se missing word sahi infer kar liya. AI gist se
              infer karne mein achha hai, zoom karne mein nahi.
            </Callout>
            ...
            <Callout label="Power-User Recipe: Designer-Quality Diagrams">
              ...
              labels/arrows preserve karne ko kaho. (2) SVG ko 2x resolution
              PNG mein convert karo. (3) PNG ko ChatGPT/Gemini mein paste kar
              ke bolo &ldquo;professional design quality mein redraw karo,
              har label/box/arrow preserve karo, sirf visual finish
              behtar karo.&rdquo; (4) 3-4 rounds iterate karo. Total time:
              10-15 minute, Figma mein 1 ghante ke muqable.
            </Callout>
            <P>
              Audio bhi: long-form dictation (typing se zyada nuance capture
              karta hai), meeting transcripts context ki tarah
              (&ldquo;decisions, open questions, action items by owner&rdquo;
              maango), aur voice in/out accessibility ke liye (commute,
              walk).
            </P>
            <RecapTable
            ...
            <Callout label="Real Example">
              Ek doctor ne 45-minute patient consultation record ki, upload
              ki, SOAP format mein clinical note mangi, uncertainty flag
              karne ko kaha. 8 minute mein draft mila, 5 minute mein verify
              hua, typed version ke 25 minute ke muqable.
            </Callout>
          </Reveal>
          ...
          <Reveal>
            ...
            <P>
              Modern AI chhote games, websites, tools ek hi prompt se bana
              sakta hai. Ye chat side panel mein render hota hai, jisay{" "}
              <Strong>Artifacts</Strong> (Claude) ya <Strong>Canvas</Strong>{" "}
              (ChatGPT, Gemini) kehte hain, ek persistent object jise aap
              edit, iterate, publish (shareable link pe), embed, ya code ki
              tarah download kar sakte ho.
            </P>
            <P>3-slot recipe:</P>
            <CheckList
              items={[
...
sessions, 5-minute breaks, a satisfying click when each cycle ends.`}</PromptBox>
            <P>
              Aur bhi kaam karti hain: bill splitter (total bill, tax, names
              ke sath), outfit picker (weather ke hisab se), fireworks
              simulator, obstacle-placing game.
            </P>
            <Callout label="Ab Bhi Mushkil Kya Hai" tone="warn">
              Internet pe multiplayer (networking, accounts, matchmaking),
              aur alag language mein live AI feedback. Chhoti, ek-screen
              cheezein jinme accounts ya external services na hon, wo kaam
              karti hain. Isse aage real engineering chahiye.
            </Callout>
          </Reveal>
          ...
          <Reveal>
            ...
            <P>
              Jab aapko calculation ya graph chahiye, model code likhta hai,
              usay run karta hai, aur result use karta hai. Code execution
              bas ek aur tool hai, jaise web search. Ye zehan mein math karne
              se zyada reliable hai.
            </P>
            <Callout label="Critical Habit: Ensure Karo Ke Code Actually Chala" tone="warn">
              Silent failure mode: chhote sawalon pe AI kabhi kabhi code skip
              kar deta hai, guess kar leta hai, ek confident paragraph deta
              hai jiske peeche koi computation nahi hoti. Bachao:
            </Callout>
            <CheckList
              items={[
            ...
            <Callout label="Bubble Tea Shop Example">
              ...
              quantities). Owner poochta hai: &ldquo;Which drinks had the
              biggest changes? Graph them. Write and run code, show me the
              code.&rdquo; AI month-over-month change compute karta hai, 4
              outlier drinks find karta hai, colored line graph banata hai,
              aur note karta hai: &ldquo;Strawberry matcha spring mein
              sharply rose, agli baar wo promotion dobara chalao.&rdquo;
            </Callout>
            <RecapTable
            ...
            <Callout label="Kya Double-Check Karein" tone="warn">
              Final totals (galat column sum ho sakta hai), graph ke labels
              (numbers usually sahi hote hain, captions kabhi confidently
              galat hote hain), aur wo columns jinhe AI misinterpret kar
              sakta hai (jaise &ldquo;TXN_AMT&rdquo; ko transaction amount
              samajhna jabke wo account number ho).
            </Callout>
          </Reveal>
        </section>
        ...
        <section id="part4" className="scroll-mt-24 border-t border-border pt-12 mt-12">
          <Reveal>
            ...
            <P>
              Ab ek poori category hai jise <Strong>AI desktop apps</Strong>{" "}
              kehte hain, jo aapke computer par chalti hain aur, permission
              ke sath, aapki files dhoond, parh, aur unpe act kar sakti hain.
              Cowork (Claude ki taraf se) aur OpenWork examples hain.
            </P>
            <Callout label="File Access Dene Se Pehle Ye Padho" tone="warn">
              Deleted files aksar recycle bin mein NAHI jati jab AI app unhe
              delete karti hai, gayab ho jati hain. Edited files edit history
              nahi rakhti jab tak version control na ho.
            </Callout>
            <P>Safe workflow:</P>
            <Ladder
              steps={[
                ...
                { title: "Phir Approve Karo", note: "Sirf tab execution start ho" },
              ]}
            />
            <RecapTable
          ...
          <Reveal>
            ...
            <CostLadderDiagram />
            <P>
              Free tier entry level par cost barely ek constraint hai. Bare
              chatbots (ChatGPT, Claude, Gemini, Meta AI, DeepSeek) sab free
              access dete hain jo is page ke prompts comfortably handle karta
              hai.
            </P>
            <RecapTable
            ...
            <Callout label="Model Ladder">
              Ek family ke andar bhi, 3 rungs hote hain: fast/cheap default
              roz-marra ke liye, ek reasoning level upar, aur ek heavy
              flagship sab se hard tasks ke liye. Middle rung kabhi apna alag
              entry hoti hai, kabhi Concept 5 wali thinking switch. Naam
              rotate hote hain, isliye memory ki bajaye picker parho.
            </Callout>
            <P>
              <Strong>Arena</Strong> leaderboard bookmark karne layak hai:
              users blind head-to-head mein vote karte hain, isliye rankings
              real preferences reflect karti hain, vendor marketing nahi.
              Mahine mein ek baar check karo, leaders tezi se rotate karte
              hain.
            </P>
            <CheckList
              items={[
          ...
          <Reveal>
            ...
            <P>
              Jab koi ground truth na ho (koi answer key, koi expert paas
              baitha, koi test jo red fail ho), aap phir bhi ek objective
              quality signal hasil kar sakte ho: models ko ek dusre ko grade
              karwa kar.
            </P>
            <Callout label="Sirf Alag Families Ke Sath Kaam Karta Hai">
              Alag models ke alag blind spots hote hain, overlapping lekin
              alag data pe train huye. Ye sirf tab kaam karta hai jab models
              genuinely alag families se hon: Anthropic (Claude), OpenAI
              (ChatGPT), Google (Gemini), xAI (Grok), Meta, DeepSeek. Do
              Claude models ek dusre ko check karein wo cross-model checking
            ...
            <P>
              ...
              implement karwao) bhi zyada tar tasks ko visibly better bana
              deti hai.
            </P>
...
criteria, then show me the final version.`}</PromptBox>
            <Callout label="Ek Honest Caveat" tone="warn">
              3 models sath mein bhi ek hi cheez pe galat ho sakte hain, wo
              training data share karte hain jitna aap sochenge us se zyada.
              Score progress ka signal hai, truth ka nahi. High-stakes
              content (legal, medical, financial) ke liye, koi bhi
              cross-model pass ek human expert ko replace nahi karta.
            </Callout>
            <Callout label="Privacy Note" tone="warn">
              Cross-model checking ka matlab hai apna draft kai tools mein
              paste karna. Sensitive material se pehle har tool ki data
              policy check karo. Kuch tools (Claude consumer, ChatGPT
              training opt-out ke sath, paid Gemini) aapke input pe train
              nahi karte. Kuch (Meta AI default) kar sakte hain.
            </Callout>
            <P>
              <Strong>Kab loop skip karo:</Strong> ek short email, quick
              lookup, casual brainstorm, single-model kaafi hai. Multi-model
              cross-check save karo un kaamon ke liye jahan galat hona
              expensive ho.
            </P>
          </Reveal>
        </section>
        ...
        <section id="recap" className="scroll-mt-24 border-t border-border pt-12 mt-12">
          <Reveal>
            ...
            <PullQuote>
              ...
              hua: sahi context andar dalo, ghalat context bahar rakho. Agar
              is page se sirf ye ek sentence yaad rahe, aap phir bhi top
              quartile users mein honge.
            </PullQuote>
          </Reveal>
        </section>
        ...
        <section id="practice" className="scroll-mt-24 border-t border-border pt-12 mt-12">
          <Reveal>
            ...
            <P>
              Claude, ChatGPT, ya Gemini khol ke ye 12 prompts order mein
              chalao. Taqreeban 28 minute lagte hain, aur is page ka har wo
              concept exercise hota hai jo ek chat tab se ho sakta hai.
            </P>
            <Ladder
              steps={[
        ...
        <section id="projects" className="scroll-mt-24 border-t border-border pt-12 mt-12">
          <Reveal>
            ...
            <P>
              ...
              projects unhe zanjeer mein jorte hain, aur wahan le jate hain
              jahan chat window nahi le ja sakti: ek real, public URL tak,
              jise aap dost ko text kar sakte ho.
            </P>
            <RecapTable
            ...
            <Callout label="Pehle 3 Ka Shape">
              Chat mein artifact banta hai → aap usay download karte ho ek
              file ki tarah (index.html) → internet usay serve karta hai ek
              real public URL par (jaise your-app.netlify.app). Har address
              exist karta hai kyunke aap ne plain sentences mein describe
              kiya wo kya chahte hain.
            </Callout>
            <P>
              Capstone (Project 4) exception hai jo rule prove karta hai: ye
              koi URL ship nahi karta, kyunke iska product ek cheez hai jo
              aap samajhte ho, aur proof ke aap, model nahi, in-charge thay.
            </P>
          </Reveal>
        </section>
        ...
        <section id="glossary" className="scroll-mt-24 border-t border-border pt-12 mt-12">
          ...
          <Reveal>
            <Callout label="Source Note">
              ...
              Course&rdquo;, in habits ko 6 deeper thinking disciplines mein
              le jata hai (Prediction Lock, Reasoning Receipt, Error
              Taxonomy, Thinking in Systems, First Principles, Working WITH
              AI).
            </Callout>
          </Reveal>
        </section>
            ...
            <div className="mt-6 space-y-2.5">
              {[
                ...
                },
                {
                  ...
                  a: "Training data mein us topic ki frequency roughly reliability ke barabar hai. Common topics (cooking, popular movies) strong hain. Obscure ya recent topics (regional history, knowledge cutoff ke baad ki cheezein) weak hain, primary source se verify karo.",
                },
                {
                ...
                },
                {
                  ...
                  a: "Alag families (Anthropic, OpenAI, Google, waghera) genuinely alag training data aur reward signals se banti hain, isliye unke blind spots alag hote hain. Ek hi family ke 2 models ke priors bohot similar hote hain, isliye unhe ek dusre se check karwana real cross-checking nahi hai.",
                },
                {
                  q: "Model ladder kya hai?",
                  a: "Ek family ke andar 3 rungs: fast/cheap default roz-marra ke liye, ek reasoning level upar, aur ek heavy flagship sab se hard tasks ke liye. Rung names rotate hoti rehti hain, isliye current picker check karo, memory pe bharosa mat karo.",
                },
                {
                  q: "Is poore chapter ka underlying ek move kya hai?",
                  a: "Sahi context andar dalna, ya ghalat context bahar rakhna. Almost har technique in do moves mein se ek hai, kyunke model stateless hai aur sirf usi context window se answer deta hai jo is waqt uske saamne hai.",
                },
              ].map((item, i) => (
                <details
                  key={i}
