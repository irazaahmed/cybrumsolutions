...
function FourQualitiesDiagram() {
  const items = [
    ...
    { icon: Scale, t: "Ethical", d: "AI ka role honestly batate ho, chupate nahi" },
    { icon: ShieldCheck, t: "Safe", d: "Privacy aur important info mehfooz rehti hai" },
  ];
  return (
    <figure className="my-7">
      ...
      <figcaption className="mt-3 text-center text-xs text-muted">
        Ye 4 qualities hain. 4Ds mein se har ek in mein se kam se kam ek
        quality deti hai. Ye ek durable skill hai, kuch clever prompts
        ka collection nahi
      </figcaption>
    </figure>
  );
...
function ThreeModesDiagram() {
  const modes = [
    ...
    { icon: Users, t: "Augmentation", q: "Chalo mil kar sochte hain", role: "Aap co-creator ho", d: "Aap aur AI mil kar, ek doosre ki thinking pe build karte hain" },
  ...
  return (
    <figure className="my-7">
      ...
      <figcaption className="mt-3 text-center text-xs text-muted">
        Koi mode doosre se behtar nahi hai. Asal skill ye hai ke jo mode
        task ko chahiye wahi pick karo, aur zaroorat pe teenon mein
        switch bhi kar sako
      </figcaption>
    </figure>
  );
    ...
    <figure className="my-7">
      ...
      <div className="grid gap-2.5 sm:grid-cols-3">
        {[
          ...
          { t: "Output badalta rehta hai", d: "Same sawal alag waqt pe alag jawab de sakta hai" },
          { t: "Sirf jo available hai", d: "Training, chat, documents, tools; jo missing hai wahan guess hota hai" },
        ].map((n) => (
      ...
      <figcaption className="mt-3 text-center text-xs text-muted">
        Har output ek capable colleague ka draft samjho, kabhi bhi final
        sach nahi
      </figcaption>
    </figure>
  );
    ...
    <figure className="my-7">
      <Flow
        steps={[
          ...
          "Platform Awareness: pata ho kaunsa AI tool is task ke liye sahi hai",
          "Task Delegation: kaam ko jaan-boojh kar divide karo",
        ]}
      />
      <figcaption className="mt-1 text-center text-xs text-muted">
        Pehle domain expert bano, phir AI delegator. Kyunki AI expertise
        ko speed karta hai, replace kam hi karta hai
      </figcaption>
    </figure>
  );
}
...
function DescriptionPartsDiagram() {
  ...
  return (
    <figure className="my-7">
      ...
      <figcaption className="mt-3 text-center text-xs text-muted">
        Yaad rakhne ka trick: What → How → Mujhse kaise deal karo.
        Complete hona clever hone se zyada important hai
      </figcaption>
    </figure>
  );
}
...
function DiligenceTimelineDiagram() {
  ...
  return (
    <figure className="my-7">
      ...
      <figcaption className="mt-3 text-center text-xs text-muted">
        &ldquo;Kya main confidently is par apna naam laga sakta hoon?
        Agar nahi, to ye ship nahi hoga.&rdquo;
      </figcaption>
    </figure>
  );
}
      ...
      <main className="mx-auto max-w-3xl px-5 pb-20 sm:px-8">
        <section id="intro" className="scroll-mt-24 pt-4">
          <Reveal>
            ...
            <CoreIdea>
              AI fluency ka matlab clever prompts yaad rakhna nahi. Ye 4Ds
              hain: <Strong>Delegation</Strong> (kaam divide karna),{" "}
              <Strong>Description</Strong> (AI ko wo info dena jo usay
              chahiye), <Strong>Discernment</Strong> (jo jawab aaye usay
              check karna), aur <Strong>Diligence</Strong> (zimmedari
              lena). In 4 ke bina powerful AI use karo, to result galat
              ya risky nikal sakta hai.
            </CoreIdea>
          </Reveal>
          ...
          <Reveal>
            ...
            <P>
              Socho aapki team mein ek talented naya banda join karta
              hai. Pehle hi din aap bolte ho, &ldquo;AI agents pe ek
              course outline bana do.&rdquo; Kuch ghanton baad wo PhD
              researchers ke liye ek polished outline deta hai, poore
              semester ka timeline, aur hands-on practice na ke barabar.
              Problem uski capability mein nahi thi, problem ye thi ke
              usay proper direction nahi mili.
            </P>
            <Callout label="Key Distinction">
              Human colleague se ye farq hai: AI conversations ke beech
              kuch bhi yaad nahi rakhta. Har naya chat ek aisi entity se
              shuru hota hai jo aapse pehle kabhi mili hi nahi. Jo baat
              aap kisi insaan ko ek baar batate ho, wahi baat AI ko har
              baar dobara batani parti hai — ya kahin aisi jagah rakhni
              parti hai jahan se wo khud parh le. Ye koi kami nahi hai,
              ye ek working condition hai jiske around plan karna parta
              hai. Yehi planning karna un 4 essential skills mein se ek
              hai.
            </Callout>
            <P>
              Ek powerful AI bhi, agar sath weak tareeke se kaam kiya
              jaye, to galat result deta hai. Sirf clever prompts pata
              hona kaafi nahi. <Strong>AI Fluency ka matlab ye hai</Strong>{" "}
              ke AI ko kya dena hai, usay kaise guide karna hai, uske
              kaam ko kaise judge karna hai, aur kab use ya trust nahi
              karna — ye sab pata hona.
            </P>
          </Reveal>
          ...
          <Reveal>
            ...
            <P>
              Ye framework Professor Rick Dakan aur Professor Joseph
              Feller ne banaya, aur Anthropic ke sath milkar tayar kiye
              courses mein taught hota hai. Isme 4 human competencies
            ...
            />
            <P>
              Simple words mein: pehle decide karo, phir explain karo,
              phir check karo, phir zimmedari lo. Parhne mein roughly 30
              minute lagte hain, plus practice prompts ke liye 15-20
              minute alag se.
            </P>
          </Reveal>
          ...
          <Reveal>
            ...
            <Flow
              steps={[
                "\"What AI Actually Is\", jo machine explain karta hai",
            ...
            <RecapTable
              ...
              rows={[
                ["AI kaise kaam karta hai", "In-depth", "Quick reminder", "Assume kiya gaya hai"],
                ["Communicate kaise karein", "Context kyun matter karta hai", "Description", "Practical techniques"],
                ["Jawab kaise judge karein", "Plausible galat kyun ho sakta hai", "Discernment", "Model-checking habits"],
            ...
            />
            <Callout label="Note">
              Techniques to models improve hone ke sath badalti rahengi,
              lekin ye 4 competencies isliye banayi gayi hain ke ye tikti
              rahen.
            </Callout>
          </Reveal>

          <Reveal>
            <SubHeading>3 Minute Mein Farq Dekho</SubHeading>
            <P>Pehla prompt, generic:</P>
            <PromptBox>Write a welcome email for new members.</PromptBox>
            <P>Result theek tha, grammar sahi thi, lekin bilkul generic tha.</P>
...
dropped.`}</PromptBox>
            <P>
              ...
              behtar tha. Isse 2 cheezein pata chalti hain. Pehli, dono
              results ka farq human ki taraf se aaya, model ki taraf se
              nahi. Doosri, aap doosre email ko behtar isliye judge kar
              paye kyunki aap cycling clubs, nervous beginners, aur
          ...
          <Reveal>
            ...
            <P>Course complete hone tak, aapko ye cheezein explain karni aani chahiyen:</P>
            <CheckList
              items={[
                "AI fluency ka matlab, sirf \"prompts mein achha hona\" se aage kya hai",
                "Automation, augmentation, aur agency mein farq",
                "Kaam ka kaunsa hissa khud rakhna hai aur kaunsa AI ko dena hai, ye kaise decide karein",
                "Description ke 3 types: product, process, aur performance",
                "AI ke output ko sirf confident jawab dekh kar accept karne ki jagah, use kaise evaluate karein",
        ...
        <section id="part1" className="scroll-mt-24 border-t border-border pt-12 mt-12">
          <Reveal>
            ...
            <P>
              ...
              aane ke barabar nahi. Almost sab ke paas same models
              available hain. Same plan pe same assistant use karne wale
              2 log bilkul alag results paate hain. Farq tool mein nahi
              tha, <Strong>farq is baat mein tha ke unhone use kaise use
              kiya.</Strong>
            </P>
          </Reveal>
          ...
          <Reveal>
            ...
            <P>
              ...
              bas itni hai: AI ke around achhe human decisions lena
              seekhna. Sequence yehi hai: Delegation, phir Description,
              phir Discernment, phir Diligence — ya simple words mein:
              decide karo, explain karo, check karo, zimmedari lo.
            </P>
            <Callout label="Agent Factory Readers Ke Liye Important">
              Ye sabse pehle aata hai. Mode 1 mein aap general agents
              use karte ho problems solve karne ke liye. Mode 2 mein aap
          ...
          <Reveal>
            ...
            <CheckList
              items={[
                "Plausible, correct ke barabar nahi hai — AI aisa confident jawab de sakta hai jo galat ho (hallucination)",
                "Output badalta rehta hai, same request alag waqt pe alag jawab de sakti hai",
          ...
          <Reveal>
            ...
            <P>
              ...
              Log AI ke sath 3 broad modes mein kaam karte hain, aur inka
              farq mainly is baat se hota hai ke{" "}
              <Strong>AI ko agla step khud decide karne ki kitni azaadi
              di gayi hai.</Strong>
            </P>
            <ThreeModesDiagram />
          </Reveal>
          ...
          <Reveal>
            ...
            <P>
              ...
              business idea pe brainstorm karna, software architecture
              review karna, lesson plan behtar banana, do strategies
              compare karna, ya koi aisa sawal explore karna jiska jawab
              aapko khud abhi pata nahi. Yahan AI ek{" "}
              <Strong>thinking partner</Strong> ki tarah kaam karta hai,
              sirf instructions execute nahi karta. Aap aur AI ke beech
              kai turns back and forth hote hain: aap poochte ho, wo
              jawab deta hai, aap challenge karte ho, wo revise karta
              hai.
            </P>
          </Reveal>
          ...
          <Reveal>
            ...
            <P>
              Agency mein aap AI ko ek goal aur boundaries de dete ho,
              phir usay kai steps khud decide karne dete ho.
              &ldquo;Ye 5 emails parh ke summary do&rdquo; kehne ki
              jagah, aap kuch aisa bolte ho:
            </P>
...
and ask me before doing anything you are unsure about."`}</PromptBox>
            <P>
              Ab AI ko khud decide karna parta hai ke kya routine hai,
              kya important hai, aur kab poochna hai. Yahan aap script
              writer se <Strong>director</Strong> ban jate ho. 2 words
              yahan bohot weight rakhte hain. Pehla, <Strong>future</Strong>{" "}
              — matlab aap us waqt present nahi ho, aap ne Monday ko sab
              set kar diya aur Thursday ka kaam khud ho raha hai jab aap
              so rahe ho. Doosra, <Strong>for others</Strong> — matlab
              jis insaan ki AI service kar rahi hai, wo khud aap na bhi
              ho. Automation aur augmentation mein aap chair pe baithe
              rehte ho, lekin agency mein aap chair se uth jate ho. Mode
              2 ki har mushkil isi ek fact se aati hai: aap har decision
              supervise nahi kar sakte, isliye judgment pehle se
            ...
            <RecapTable
              ...
              rows={[
                ...
                ["Common failure", "Ek step galat ho jata hai", "Goal ya boundary misunderstand ho jati hai"],
              ]}
            />
            <P>
              Koi mode dusre se automatically behtar nahi hota. Ek achha
              AI user wahi mode pick karta hai jo task ko chahiye, aur
              ek project mein teenon mode use ho sakte hain. Mode 1
              zyada tar automation aur augmentation use karta hai, jabke
              Mode 2 agency ko systematic bana deta hai. Ek Digital FTE
              sirf itna nahi ke &ldquo;AI kaam kar rahi hai&rdquo;, balke
              ye ek job definition, System of Record, permissions,
              rules, aur governance ke andar reh kar kaam karta hai.
            </P>
          </Reveal>
        </section>
        ...
        <section id="delegation" className="scroll-mt-24 border-t border-border pt-12 mt-12">
          <Reveal>
            ...
            <P>
              Beginners ki sabse common ghalti pehle prompt se bhi pehle
              ho jati hai. Log AI assistant khol kar seedha type karna
              shuru kar dete hain, jabke unhone abhi ye decide hi nahi
              kiya hota ke actually achieve kya karna hai, achha result
              kaisa dikhega, kaunsa hissa AI kare, kaunsa khud karein,
              aur kaunse decisions kabhi AI ko na diye jayen. Yehi{" "}
            ...
            <Callout label="Definition">
              ...
              &ldquo;AI ko kaam de diya&rdquo; nahi hai, ye poori
              workflow design karna hai.
            </Callout>
            <DelegationPartsDiagram />
            <Callout label="Yaad Rakho">
              Pehle domain expert bano, phir AI delegator, kyunki AI
          ...
          <Reveal>
            ...
            <P>
              ...
              kuch na kuch bana to dega, lekin kai hard sawal abhi bhi
              unanswered rahenge — kaunse customers ko contact karein,
              invoice kitne din late hone pe follow-up bheja jaye,
              kaunsa tone use ho, kitni amount pe human ki approval
              chahiye, agar customer invoice pe dispute kare to kya
              kiya jaye, agent kaunsa accounting system parh sakta hai,
              aur ye ke agent sirf message ka draft banaye ya khud bhej
              bhi sake. <Strong>Ye business questions hain, prompting
              questions nahi.</Strong> AI aapki business policy khud se
              decide nahi kar sakta jab tak aap jaan-boojh kar usay ye
              authority na dein — aur zyada tar cases mein aapko dena
              bhi nahi chahiye.
            </P>
          </Reveal>
          ...
          <Reveal>
            ...
            <P>
              Har AI system har task mein equally achha nahi hota.
              Mushkil, multi-step problems ke liye reasoning model pick
              kar sakte ho, current info ke liye search-enabled
              assistant, software banane ke liye coding agent, aur un
              tasks ke liye jinme tools aur multiple steps shamil hon,
              agent-capable system. Ek achi habit ye hai ke khud se
              poocho, &ldquo;kya ye tool is job ke liye sahi hai?&rdquo;
              Alag alag systems try karo, unke results compare karo, aur
              note karte raho ke kya kaam kar raha hai.
            </P>
          </Reveal>
          ...
          <Reveal>
            ...
            <P>
              Jab problem aur platform, dono samajh mein aa jayen, to
              kaam ko soch samajh kar parts mein divide karo. Ek
              example, ek course banate waqt:
            </P>
            <RecapTable
            ...
            <Callout label="Better Question">
              ...
              poocho: <Strong>&ldquo;Kaunsa hissa AI kare, kaunsa main
              karoon, aur kyun?&rdquo;</Strong>
            </Callout>
            <P>
              Agent Factory mein Delegation ek engineering step ban
              jati hai. Problem Awareness ek <Strong>specification</Strong>{" "}
              ban jati hai — yani goal, constraints, risks, aur
              &ldquo;definition of done&rdquo;. Task Delegation Digital
              FTE ki boundary ban jati hai, jo decide karti hai AI kya
              kar sakta hai, humans kya apne paas rakhte hain, aur kya
              escalate hona chahiye. Aur ek vertical System of Record in
              decisions ko durable aur inspectable banata hai.
            </P>
          </Reveal>
        </section>
        ...
        <section id="description" className="scroll-mt-24 border-t border-border pt-12 mt-12">
          <Reveal>
            ...
            <P>
              Shuru wale colleague ko yaad karo, uski outline isliye
              galat thi kyunki usay zaroori information nahi di gayi
              thi. AI ko bhi yehi problem hoti hai, magar zyada
              severely. Wo aapka mind read nahi kar sakta. Agar aap koi
              zaroori cheez chhor dein, to wo ek reasonable guess laga
              leta hai — aur ye reasonable guess bhi galat ho sakti hai.
            </P>
            <Callout label="Definition">
              <Strong>Description</Strong> wo skill hai jisse aap AI ko
              wo information aur guidance dete ho jo usay kaam achi
              tarah karne ke liye chahiye. Ye sirf &ldquo;ek achha prompt
            ...
            <Callout label="Key Principle">
              ...
              prompt clever nahi hota, complete hota hai.&rdquo; Scale
              pe, description khud <Strong>context engineering</Strong>{" "}
              ban jati hai — yani wo har cheez design karna jo AI ko
              succeed karne ke liye chahiye, sirf ek message ki wording
              nahi.
            </Callout>
          </Reveal>
...
accounting jargon.`}</PromptBox>
            <P>
              ...
              complete</Strong> hai. Complete hona aksar clever wording
...
code actually works.`}</PromptBox>
            <P>
              Process description sabse zyada tab matter karti hai jab
            ...
            <Ladder
              steps={[
                ...
                { title: "Compare", note: "Sirf table use kar ke vendors compare karo. Check: har farq actually table mein hai?" },
            ...
            <Callout label="General Rule" tone="warn">
              Jis step ki ghalti sabse door tak spread hoti hai, wo pehle
              aana chahiye — aur aage barhne se pehle usay check karo.
              Extraction isliye pehle hai kyunki table mein galat prices
              comparison, scoring, aur draft tak carry ho jati hain, aur
              aakhir tak sahi lagti rehti hain.
            </Callout>
          </Reveal>
...
If yours is stronger, hold your position and explain it.`}</PromptBox>
            <P>
              Isse AI ek polite jawab machine se behtar thinking partner
              ban jata hai. Iske 2 versions hain. Chhota version, chat
              window mein, sirf aapke liye. Bara version, ek deployed
              agent mein — jaise ek tutoring agent ka rule &ldquo;student
              ke attempt karne se pehle answer mat do.&rdquo; Ye same
              sentence hai bas stakes badal gaye: ek baar likha jata
              hai, aur hazaar baar un logon pe apply hota hai jinse aap
              kabhi mile hi nahi. Chat mein ek weak performance
              description 10 minute annoy karti hai, lekin ek deployed
              agent mein wahi khud <Strong>product</Strong> ban jati hai.
            </P>
          </Reveal>
          ...
          <Reveal>
            ...
            <P>
              ...
              2026&rdquo;</Strong>, practical techniques sikhata hai —
              jaise examples dena, constraints specify karna, tasks ko
              chhote parts mein todna, aur roles define karna. Ye
              chapter is se bhi bigger idea sikhata hai:{" "}
              <Strong>Description.</Strong>
            </P>
            <P>
              Kai teams ek prompt template use karti hain jisme role,
              context, task, constraints, aur output format ke liye
              jagah hoti hai. Task, constraints, aur output format,
              actually <Strong>product description</Strong> hi hain.
              Context wahi cheez hai jise agla section{" "}
              <Strong>context engineering</Strong> kehta hai. Agar kaam
              kaise aage badhega iske liye ek line, aur AI aapke sath
              kaise behave karega iske liye ek line add kar do, to ye
              template teenon parts cover kar leta hai.
            </P>
            <Callout label="Note">
              Kisi cheez ko phrase karne ka tareeka pata nahi? Ruk mat
              jao. Apni situation normal words mein explain karo, aur AI
              se poocho ke wo isay clear instruction mein badal de.
            </Callout>
          </Reveal>
          ...
          <Reveal>
            ...
            <P>
              ...
              prompt bhi agent ko nahi bacha sakta agar uske paas galat
              data ho, rules missing hon, weak examples hon, ya zaroori
              tools tak access na ho. Agent Factory mein: system prompt
              ek performance description ko persistent banata hai, ek{" "}
              <Strong>SKILL.md</Strong> ek process description ko
              reusable banata hai, aur ek System of Record domain
              knowledge, rules, definitions, aur governance rakh sakta
              hai.
            </P>
          </Reveal>
        </section>
        ...
        <section id="discernment" className="scroll-mt-24 border-t border-border pt-12 mt-12">
          <Reveal>
            ...
            <P>
              ...
              useful hai, lekin trust ke liye risky hai. Ek galat AI
              answer usually kisi warning label ke sath nahi aata, wo
              polished, detailed, aur certain dikh sakta hai.
            </P>
            <Callout label="Definition">
              <Strong>Discernment</Strong> AI ka diya hua kaam judge
              karne ki ability hai. Description poochti hai &ldquo;kya
              maine kaam clearly explain kiya?&rdquo;, Discernment
              poochti hai &ldquo;kya AI ne actually kaam achi tarah
              kiya?&rdquo;
            </Callout>
            <Callout label="Important Term" tone="warn">
              <Strong>Automation Bias:</Strong> ek automated jawab ko
          ...
          <Reveal>
            ...
            <P>
              ...
              dikh sakta hai. Fluent writing koi proof nahi, citation
              jaisi link koi proof nahi, confident tone bhi koi proof
              nahi. 4 signs jo aksar fake answer show karte hain:
            </P>
            <RecapTable
              head={["Sign", "Kya Karo"]}
              rows={[
                ["Bohot zyada exact specifics", "Number repeat karne se pehle asal source khol kar check karo"],
                ["Wahan confidence jahan expert bhi hesitate kare", "Poocho ke kya cheez jawab badal degi"],
          ...
          <Reveal>
            ...
            <CheckList
              items={[
                ...
                "Kya har zaroori requirement follow hui?",
            ...
            />
            <P>
              <Strong>Ek zaroori baat:</Strong> yahan aapki apni domain
              knowledge bohot valuable ban jati hai. Ek accountant weak
              assumptions pakar leta hai, ek programmer subtle bugs
              pakar leta hai, aur ek teacher wo explanations pehchan
              leta hai jo beginners ke liye confusing hon. &ldquo;AI
              expert work ki speed barha sakta hai, lekin ye expertise
              ki zaroorat khatam nahi karta.&rdquo;
            </P>
            <P>
              Result ke peeche ki <Strong>reasoning ko bhi judge karo</Strong>,
              kyunki AI weak reasons ke sath bhi correct answer tak
              pahunch sakta hai, aur ek galat assumption pe khara
              correct answer zyada der correct nahi rehta. Useful ye hai
              ke AI se ye dikhwao: assumptions, evidence, decision
              criteria, calculations, intermediate results, aur
              alternative interpretations. Inhe ek{" "}
              <Strong>review ke liye justification</Strong> samjho,
              hidden reasoning ka literal transcript nahi.
            </P>
...
the proposal's section heading and the sentence it came from.`}</PromptBox>
            <P>
              Ye 3 kaam karta hai. Pehla, sirf wahi cheez use karta hai
              jo attach ki gayi ho, taake training knowledge se gaps na
              bharein, jahan se imaginary features aati hain. Doosra, ye
          ...
          <Reveal>
            ...
            <P>
              Kabhi kabhi answer theek hota hai lekin AI ke sath kaam
              karne ka tareeka theek nahi hota. Ye wo sawal hai jo log
              almost kabhi nahi poochte, kyunki output acceptable laga
              aur session successful feel hua. Khud se ye poocho:
            </P>
            <CheckList
              items={[
                "Kya AI mere feedback ke hisab se adapt kar raha hai, ya wapis purani cheez pe drift ho raha hai?",
                "Kya do baar correct karne ke baad bhi wahi ghalti repeat kar raha hai?",
            ...
            <Callout label="Honest Reflection">
              Last question pe khaas dhyan do: 20 minute ka steering jo
              ek hour bacha de, wo ek win hai. 20 minute ka steering jo
              sirf 15 minute bacha de, wo actually ek loss hai jise aap
              win samajh rahe ho kyunki wo productive feel hui.
            </Callout>
            <P>
              Jab ye process kaam nahi kar raha, teen escalating moves
              hain, aur teenon fluency hain: performance description
              badlo, tool badlo, ya task wapis khud apne paas le lo.
          ...
          <Reveal>
            ...
            <P>
              ...
              book ke end mein isi ki sabse zyada care ki jati hai. Ye ye
              sawal poochti hai ke kya AI ka{" "}
              <Strong>independent, user-facing behavior</Strong> logon
              ke liye achhe outcomes deta hai. Ye is baat se different
              hai ke koi ek output correct tha ya nahi. Example: ek AI
              tutor har sawal ka correct jawab de sakta hai, aur phir bhi
              bad tutor ho sakta hai agar wo student ke hesitate karte hi
              solution de deta hai, jisse koi kuch nahi seekhta. Isi
              tarah ek support agent tickets ko fast resolve kar sakta
              hai, aur phir bhi bad ho sakta hai agar wo conversation us
              waqt band kar de jab customer ne usay abhi complete na
              samjha ho. Ye single chats mein nahi, aggregate mein show
              hota hai: users iske baad kya karte hain, wo kis baat pe
              complain karte hain, aur kaunse cases baar baar chupke se
              wahi galat hote hain. Aap thousands conversations khud
              check nahi kar sakte, isliye kuch aisa banana parta hai jo
              aapki jagah in par nazar rakhe.
            </P>
          </Reveal>
          ...
          <Reveal>
            ...
            <Flow
              ...
              steps={[
                ...
                "Aap batate ho kya badalna hai",
              ]}
            />
            <P>
              Jab Discernment koi problem flag kare, to usually iska fix
              behtar description hota hai. Kabhi kabhi ye wapis
              Delegation tak le jata hai — ya to galat tool ki wajah se,
              galat split ki wajah se, ya phir galat approach ki wajah
              se. <Strong>&ldquo;Professional AI collaboration
              iteration se converge hoti hai, ye kabhi ek hi shot mein
              perfect nahi hoti.&rdquo;</Strong>
            </P>
          </Reveal>
          ...
          <Reveal>
            ...
            <P>
              ...
              response aksar ek draft hota hai, finish line nahi.
              Feedback dete waqt is pattern ka use karo: problem batao,
              phir ye ke wo kyun matter karta hai, phir direction do.
            </P>
            <P>Weak feedback:</P>
...
one-person business with a limited budget.`}</PromptBox>
          ...
          <Reveal>
            ...
            <P>
              Kyunki wo galat reader ke liye likha gaya tha. Ek example,
              ek quarterly report ki finding, board aur support team,
              dono ke liye alag alag likho:
            </P>
            <RecapTable
              ...
              rows={[
                [
                  ...
                  "Kya badla, ye unki ghalti kyun nahi, aur Monday ko kya karna hai: \"Tickets is quarter double huye, team same size rahi, isliye 9-hour replies volume se aayi hain, aapse nahi. Do hires ki request ho chuki hai. Jab tak wo aayen, sabse purana ticket pehle karo.\"",
                ],
              ]}
            />
            <P>
          ...
          <Reveal>
            ...
            <CheckList
              items={[
                ...
                "Aap khud kaam apne haath mein le lete ho, kyunki fix ke liye sirf aap jaante ho",
              ]}
            />
            <Callout label="Important Practice">
              ...
              ending pehchan lena us &ldquo;bas ek aur chhoti
              change&rdquo; wale loop ko rok deta hai jo poora din kha
              jata hai.
            </Callout>
            <P>
              Kabhi kabhi behtar description bhi kaafi nahi hoti, aur
              Discernment dikha deti hai ke original Delegation decision
              hi galat tha — shayad galat tool choose hua, shayad AI ko
              wo hissa kabhi milna hi nahi chahiye tha, ya shayad ye
              kaam ek human expert hi maangta hai. Ye bhi fluency hai.
              Agent Factory mein Discernment <Strong>evaluation
              engineering</Strong> ban jati hai — yani aapka personal
              sawal &ldquo;kya ye kaafi achha hai?&rdquo; eval suites,
              production checks, monitoring, sampling, aur release gates
              ki shape le leta hai.{" "}
              <Strong>&ldquo;Aap wo judgment automate nahi kar sakte jo
              aapne khud kabhi seekha hi nahi.&rdquo;</Strong>
            </P>
          </Reveal>
        </section>
        ...
        <section id="diligence" className="scroll-mt-24 border-t border-border pt-12 mt-12">
          <Reveal>
            ...
            <P>Pehli 3 Ds behtar results lane mein help karti hain. Diligence ek alag sawal poochti hai:</P>
            ...
            <Callout label="Example: Lecture Feedback Ka Case" tone="warn">
              Ek teacher AI se end-of-term student feedback draft
              karwata hai. Writing excellent hoti hai. Lekin usne
              student names, grades, aur disciplinary notes ek consumer
              AI service mein paste kar diye jise university ne approve
              nahi kiya tha. Students ko bataya hi nahi gaya ke unke
              academic record ka ye hissa AI ki help se bana.{" "}
              <Strong>Output achha ho sakta hai, lekin AI ka ye use phir
              bhi irresponsible hai.</Strong>
            </Callout>
            <Callout label="Definition">
              <Strong>Diligence</Strong> ka matlab hai AI kaise use hui,
              aur uske output ka kya hua, iski zimmedari khud lena.
            </Callout>
          ...
          <Reveal>
            ...
            />
            <P>
              <Strong>Aasan raasta hamesha responsible raasta nahi
              hota.</Strong> Iska fix aksar ye nahi hota ke task chhor
              diya jaye, balke ye hota hai ke data ko{" "}
              <Strong>strip</Strong> kar diya jaye. Teacher wale example
              mein, wo naam aur student ID hata sakta tha, sirf grade
              range aur ek behavior rakh sakta tha, aur usi se feedback
              draft kar sakta tha. Principle ye hai: &ldquo;AI ko pattern
              chahiye, person nahi.&rdquo; Isay <Strong>redaction</Strong>{" "}
              kehte hain.
            </P>
            <RecapTable
            ...
            <Callout label="Ek Test">
              Kya koi sirf ye paste kiya hua parh kar samajh sakta hai ye
          ...
          <Reveal>
            ...
            <P>
              Har AI-assisted task ko public announcement ki zaroorat
              nahi hoti. Lekin jab AI dusre logon ko significantly
              affect kare, to disclosure matter karti hai: academic
              work, hiring decisions, customer communications, medical
              ya financial advice, professional reports, ya aisa content
              jo original human work ki tarah present kiya jaye. Exact
              rules context, organization, law, aur professional
              standard pe depend karti hain.
            </P>
            <Callout label="Guiding Principle">
              &ldquo;AI-assisted result jitna zyada dusron ko affect
              karta hai, transparency ka case utna hi strong hai.&rdquo;
          ...
          <Reveal>
            ...
            <P>
              ...
              ye transparency ka principle decide karta hai — jitne
              zyada log affect hote hain, utni zyada checking chahiye:
              khud ke liye likha note ek nazar leta hai, welcome email
              full read leta hai, aur regulator ko jane wali report ek
              second reviewer se guzarti hai.
            </P>
            <CheckList
              items={[
                "Facts verify karo",
          ...
          <Reveal>
            ...
            <Callout label="Critical Rule" tone="warn">
              ...
              ke likely-looking total kya hoga — isliye total galat ho
              sakta hai chahe har line item correct ho. Number
              spreadsheet, calculator, ya AI ke chalaye hue us code se
              lo jo aapko dikhaya gaya ho, phir inputs check karo, sum
              nahi: sahi rows aur sahi rate use hui?
            </Callout>
          </Reveal>
          ...
          <Reveal>
            ...
            <P>Agar jawab &ldquo;na&rdquo; hai, to kaam ready nahi hai.</P>
            <P>
              Kabhi kabhi case clear galat nahi hota, sirf unclear hota
              hai. Example: ek AI-ranked job applicant shortlist
              reasonable lagti hai, lekin pata nahi chalta ke wo
              silently do universities ke graduates ko favor kar rahi
              hai ya nahi. Decide karne se pehle ye 4 sawal poocho:
            </P>
            <CheckList
              items={[
                "Is result se kaun affect hota hai, un logon samet jo ise kabhi dekhenge bhi nahi?",
                "Unke liye kya galat ho sakta hai, aur kya wo bata bhi payenge?",
                "Yahan fair outcome kaisa dikhega?",
                "Kya kisi cheez ka disclose hona chahiye, aur kis ko?",
              ]}
            />
            <P>
              Agar aap chaaron ka jawab de sakte ho, to decide karo aur
              likh lo. Agar nahi, to guess kar ke bhejne ki jagah, us
              decision ke owner tak baat pahunchao.{" "}
              <Strong>Guessing ek unclear case ko aapki apni ghalti
              bana deta hai.</Strong>
            </P>
            <PullQuote>AI kaam khud kar sakta hai, lekin responsibility khud nahi le sakta.</PullQuote>
            <P>
              Agar ek AI-assisted system koi harmful decision le leta
              hai, to us system ko chalane wali organization phir bhi
              responsible rehti hai. Agar coding assistant koi
              vulnerability introduce kar de aur engineer usay ship kar
              de, to engineer aur organization, dono result ke owner
              rehte hain. Agent Factory isliye governance ko sabse pehle
              rakhta hai: Creation diligence data rules, access control,
              aur approved-tool policy ban jati hai. Transparency
              diligence disclosure aur user experience design ban jati
              hai. Deployment diligence evaluation gates, audit logs,
              monitoring, aur human review ban jati hai.
            </P>
            <Callout label="Policy Bhi Ek Responsibility Hai">
              Koi bhi policy tabhi kaam karti hai jab approved tool utna
              hi aasan reach ho jitna wo tool jo log pehle se khula
              rakhte hain. Teacher ka use kiya hua consumer service ek
              click door tha. Agar university ka approved tool ek
              request form aur ek hafte ke wait ke baad milta, to ye bhi
              ek policy flaw thi, sirf teacher ki personal ghalti nahi.
              Mode 2 mein aap sirf khud responsible AI practice nahi kar
              rahe, aap us responsibility ko ek aise product mein build
              kar rahe ho jise dusre log use karenge.
            </Callout>
          </Reveal>
        </section>
        ...
        <section id="part3" className="scroll-mt-24 border-t border-border pt-12 mt-12">
          <Reveal>
            ...
            />
            <P>
              <Strong>Delegation</Strong> decide karti hai AI kaam mein
              aaye ya nahi, aur kya own kare. <Strong>Description</Strong>{" "}
              AI ko goal, context, process, aur behavior deti hai.{" "}
              <Strong>Discernment</Strong> result check karti hai aur
              agla round behtar banati hai. <Strong>Diligence</Strong>{" "}
              poore process ko zimmedari se cover karti hai.
            </P>
          </Reveal>
          ...
          <Reveal>
            ...
            <P>
              ...
              Digital FTE bana rahi hai. Pehla kaam jo automate karna
              hai, wo hai monthly bank reconciliation.
            </P>
            <Ladder
              steps={[
                ...
                { title: "Step 3 · Discernment", note: "Ayesha ye assume nahi karti ke agent sirf isliye theek kaam kar raha hai kyunki demo achi lagi. Wo agent ko purani, trusted reconciliations ke against test karti hai: kitne matches correct hain, kitne galat matches slip karte hain, sahi cases escalate hote hain ya nahi, kya agent zaroorat se zyada escalate kar raha hai, aur kya performance waqt ke sath change ho rahi hai. Ek accountant kuch \"successful\" matches ka bhi review karta hai, sirf failures ka nahi, kyunki koi system silently fail ho kar bhi safe dikh sakta hai." },
            ...
            />
            <P>
              Yehi 4D loop practice mein hai. <Strong>Ek personal skill
              ek system property ban gayi.</Strong>
            </P>
          </Reveal>
          ...
          <Reveal>
            ...
            />
            <P>
              <Strong>&ldquo;Agent Factory AI fluency replace nahi
              karta. Wo use industrialize karta hai.&rdquo;</Strong>
            </P>
          </Reveal>
          ...
          <Reveal>
            ...
            <RecapTable
              ...
              rows={[
                ["Pehle 10%: direction set karo", "Delegation aur Description yahan sabse strong hain, decide karo kya karne layak hai, goal clear karo"],
                ...
                ["Last 10%: sach judge karo", "Kuch bhi ship hone se pehle Discernment critical ban jati hai"],
        ...
        <section id="mistakes" className="scroll-mt-24 border-t border-border pt-12 mt-12">
          <Reveal>
            ...
            <RecapTable
              ...
              rows={[
                ...
                ["Pehle jawab ko hi final samajh lena", "Description + Discernment loop", "Result inspect karo, specific feedback do, aur iterate karo"],
                ["Professional sounding answer pe blindly trust karna", "Discernment", "Zaroori facts, assumptions, calculations, aur sources verify karo"],
                ["Privacy/accountability ke baare mein sirf kuch galat hone ke baad sochna", "Diligence", "Deployment se pehle data, disclosure, approval, aur accountability rules decide karo"],
              ]}
            />
          </Reveal>
          ...
          <Reveal>
            ...
            <RecapTable
              ...
              rows={[
                ...
                ["Discern", "Mujhe kaise pata chalega jawab correct, complete, aur useful hai?"],
                ["Be diligent", "Data mehfooz hai? AI ke role ko disclosure chahiye? Result ko kaun approve/own karta hai?"],
              ]}
            />
            <P>
              Har chhote task ke liye ise paperwork banane ki zaroorat
              nahi, maqsad bas itna hai ke ye 4 sawal apne aap zehan mein
              aa jayen.
            </P>
          </Reveal>
          ...
          <Reveal>
            ...
            <P>
              AI fluency prompts ratta lagane ki ability nahi hai. Ye AI
              ke sath <Strong>effectively, efficiently, ethically, aur
              safely</Strong> kaam karne ki ability hai. Iske 3 modes
              hain: Automation (AI defined task karta hai), Augmentation
              (aap aur AI sath sochte hain), aur Agency (AI aapke set
              kiye goal ki taraf khud kaam karta hai, aksar un logon ke
              liye jo aap khud nahi hain).
            </P>
            <PullQuote>
              Decide karo AI kya kare. Kaam ko clearly describe karo. Jo
              wapis aaye usay check karo. Aage jo bhi ho uska zimmedar
              bano.
            </PullQuote>
          </Reveal>
        </section>
        ...
        <section id="practice" className="scroll-mt-24 border-t border-border pt-12 mt-12">
          <Reveal>
            ...
            <P>
              Sirf parhna kaafi nahi, ek AI assistant khol kar ye
              exercises khud try karo. Sab ek hi sitting mein complete
              karna zaroori nahi.
            </P>
            <Ladder
              steps={[
                {
                  ...
                  note: "Koi real task chuno aur AI se poocho ke wo ek ek kar ke Delegation, Description, Discernment, Diligence pe sawal poochhe, jo apply na ho wo skip kar de, aur end mein ek chhoti table de. Dhyan do: plan zyada tar aapke apne answers se banta hai, AI ke nahi, kyunki Delegation aur Diligence sirf aap khud decide kar sakte ho.",
                },
                {
                  title: "2. Ek Jani-Pehchani Topic Pe Discernment Try Karo",
                  note: "Ek aisi topic pe baat karo jismein aapko actually experience ho, aur AI se kaho ke wo ek knowledgeable colleague ki tarah baat kare, teacher ki tarah nahi. Dhyan do: jab domain aapki khud ki ho to Discernment kitni cheap feel hoti hai, aap bina effort ke galat claim pakar lete ho.",
                },
                {
                  title: "3. Non-Expert Hone Ka Feel Karo",
                  note: "Ek aisi topic chuno jisme aapko kuch bhi pata na ho, aur AI se kaho ke wo ek beginner ke liye explain kare, aur end mein wo claims batae jo aapko verify karni chahiyen. Dhyan do: same quality output kitna different feel hota hai jab check karne ko kuch bhi na ho — yehi feeling har us user ki hai jo aapka banaya agent use karega.",
                },
                {
                  title: "4. Ek Performance Description Likho",
                  note: "Session ke shuru mein hi AI ko bata do ke wo weak assumptions ko challenge kare, uncertainty flag kare, aur sirf politeness ke liye agree na kare. Dhyan do: farq kitni jaldi visible hoti hai, aur agar naya chat khol kar ye dobara na batao, to ye kitni jaldi fade ho jati hai.",
                },
                {
                  title: "5. Recommendation Se Pehle Uski Justification Check Karo",
                  note: "Koi real decision AI ko do aur usay assumptions, evidence, criteria, aur uncertainties list karne ko kaho, phir recommendation mangwao. Dhyan do: koi bhi assumption jo aap bina likhe silently accept kar lete, wahi sabse zyada check karne layak hai.",
                },
                {
                  title: "6. Ek Chhota Project Poore 4D Loop Se Guzaro",
                  note: "Ek hour mein complete hone wala project chuno: Delegation se shuru karo, har AI-owned task se pehle description poocho, har zaroori output ke baad ruk kar evaluate karo, aur end mein facts, sensitive data, disclosure, aur approvals ka Diligence check karo.",
                },
              ]}
            />
            <Callout label="Har Exercise Ke Baad">
              Khud se poocho: &ldquo;kaunsi D mujhse sabse zyada effort
              maangti hai?&rdquo; Yehi wo competency hai jiski aapko
              sabse zyada practice karni chahiye.
            </Callout>
          </Reveal>
        </section>
        ...
        <section id="glossary" className="scroll-mt-24 border-t border-border pt-12 mt-12">
          <Reveal>
            ...
            <RecapTable
              ...
              rows={[
                ...
                ["Task delegation", "Kaam ke hisse jaan-boojh kar humans ya AI ko assign karna"],
                ...
                ["Performance discernment", "Evaluate karna ke AI ka independent, user-facing behavior logon ke liye achhe outcomes de raha hai ya nahi"],
                ...
                ["Hallucination", "Ek confident ya plausible AI output jisme fabricated ya galat information ho"],
          ...
          <Reveal>
            <Callout label="Source &amp; License Note">
              ...
              hua. Framework ka course <Strong>CC BY-NC-SA 4.0</Strong>{" "}
              ke under release hua, aur unka practical overview
              reference document <Strong>CC BY-NC-ND 4.0</Strong> ke
              under hai. Ye Cybrum notes is framework ki apni ek Roman
              Urdu explanation hain, Agent Factory book
              (agentfactory.panaversity.org) ke crash course pe based,
              uski copy nahi. Original padhne ke liye:{" "}
              <a
        ...
        <section id="self-test" className="scroll-mt-24 border-t border-border pt-12 mt-12">
          <Reveal>
            ...
            <P>
              ...
              check karo. Agar 8+ correct hon, to aap agle chapter ke
              liye ready ho.
            </P>
          </Reveal>
          <Reveal>
            <div className="mt-6 space-y-2.5">
              {[
                ...
                },
                {
                  ...
                  a: "Kyunki AI plausible output generate karta hai, aur plausible correct ke barabar nahi hota. Fluent wording facts, assumptions, ya reasoning verify nahi karti; automation bias humein confident-looking answers ko zaroorat se zyada easily trust karwa deta hai.",
                },
                {
                ...
                },
                {
                  ...
                  a: "\"Kya main confidently is par apna naam laga sakta hoon?\" Agar jawab na hai, to kaam ready nahi hai.",
                },
                {
